/* BMP085 Code, 
  ...
  modified for C++ callback for Arduino and ESP8266
...
int32_t BMP085::GetPressure()
{
  ...
  uint32_t b4, b7;
  uint32_t up = ReadUP();				// This was a function parameter and now internal Class function
